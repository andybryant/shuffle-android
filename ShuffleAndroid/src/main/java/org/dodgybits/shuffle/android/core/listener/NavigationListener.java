...
import org.dodgybits.shuffle.android.list.activity.deleteme.ContextTaskListsActivity;
import org.dodgybits.shuffle.android.list.activity.deleteme.ProjectTaskListsActivity;
...
public class NavigationListener {
    ...
    private void onViewPreferences(@Observes ViewPreferencesEvent event) {
        Intent intent = new Intent(mActivity, PreferencesActivity.class);
        mActivity.startActivity(intent);
    }

    private void onViewHelp(@Observes ViewHelpEvent event) {
    ...
    private void onViewProject(@Observes ViewProjectEvent event) {
    ...
    private void onViewTaskSearchList(@Observes ViewTaskSearchResultsEvent event) {
    ...
    private void onEditTask(@Observes EditTaskEvent event) {
    ...
    private void onEditProject(@Observes EditProjectEvent event) {
        Uri uri = ContentUris.appendId(
    ...
    private void onEditContext(@Observes EditContextEvent event) {
        Uri uri = ContentUris.appendId(
