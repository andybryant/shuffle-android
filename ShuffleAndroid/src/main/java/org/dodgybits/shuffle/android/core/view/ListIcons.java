...
public class ListIcons {
    ...
    public static final int DUE_TODAY = R.drawable.ic_drawer_due;
    public static final int DUE_NEXT_WEEK = R.drawable.ic_drawer_due;
    public static final int DUE_NEXT_MONTH = R.drawable.ic_drawer_due;
    public static final int NEXT_TASKS = R.drawable.ic_drawer_next_actions;
    public static final int PROJECTS = R.drawable.ic_drawer_projects;
